...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {COP3502C, Programming Fundamentals 1}{Gainesville, FL}
      \resumeItemListStart
        \resumeItem{Holding office hours, creating exams, and acting as a crucial resource for students}
      \resumeItemListEnd
      \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Sorting Algorithm Visualizer} $|$ \emph{JavaScript}}{May 2023}
          \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, C/C++, JavaScript, TypeScript, HTML/CSS, Swift, Java, SQL} \\
